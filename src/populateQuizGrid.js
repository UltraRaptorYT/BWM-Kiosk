export let quizDict = [
  ...
  },
  {
    ...
    chiText: [
      "虽然说文殊菩萨代表智慧，就是这样交代一句，实际师父在带领我们走近文殊菩萨，走近光明和智慧的代表，走进论典、走进经典、走进佛陀等菩萨伟大心；学会恭敬礼敬去这样的心、去熏陶这样的心、去学习这样的心。然后就必将结束我们在林林总总对境遇所产生的一切理非作呀意、观过啊，或者是由于误解、不听不明白。等等，所产生的人与人之间的伤害；必将由于听闻教典，让我们更清澈地了解什么是最正确的量，因为它就是智慧！ 从一颗无染的心、从一个无漏的心边显出一个量，我们会学校对这样的量、听闻这样的量，并在心中先熟悉、记住，慢慢地去比对自心、调整我们的心。 皈依敬文殊菩萨、归向智慧，避免由愚痴导致的一切痛苦因果。",
    ],
    engText: [
